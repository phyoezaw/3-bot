...
token = '8045266335:AAHBRWLHmBbAuoNaoHNv4S7VcRx_po-N8hI'
...
def start(message):
	if not str(message.chat.id) == '5827732412':
		bot.reply_to(
		    message,
		    "FUCK!!! You are not Authorize. This Bot is MadeBy  "
		)
		return
...
𝑷𝑹𝑶𝑿𝒀𝑺➜ 𝑳𝑰𝑽𝑬 ✅ '''
				print(last)
				if 'Thank you for your message.' in last or 'Secret' in last or 'secret' in last or 'Thank you for your donate.' in last or 'Thank you for your donation.' in last or 'Thank you' in last:
					live += 1
